...
<head>
	...
	<p>20(12)80</p>
	<p>20% DOWNPAYMENT, DOWNPAYMENT PAYABLE IN 12 MONTHS</p>
	<p>0% DOWNPAYMENT DISCOUNT</p>
...
$dp_disc			= round(($dp*.0),2,PHP_ROUND_HALF_UP);
...
LESS 0% DISCOUNT ON DOWNPAYMENT:<input type="text" value = "<?php echo $dp_disc;?>" readonly><br/>
